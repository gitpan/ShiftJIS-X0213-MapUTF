...
for $ary (@arys) {
    ...
    print !$hasUnicode || $unicode eq sjis0213_to_unicode($sjis0213)
	? "ok" : "not ok" , " ", ++$loaded, "\n";

    print $utf8    eq sjis0213_to_utf8($sjis0213)
	? "ok" : "not ok" , " ", ++$loaded, "\n";

    print $utf16le eq sjis0213_to_utf16le($sjis0213)
	? "ok" : "not ok" , " ", ++$loaded, "\n";

    print $utf16be eq sjis0213_to_utf16be($sjis0213)
	? "ok" : "not ok" , " ", ++$loaded, "\n";

    print $utf32le eq sjis0213_to_utf32le($sjis0213)
	? "ok" : "not ok" , " ", ++$loaded, "\n";

    print $utf32be eq sjis0213_to_utf32be($sjis0213)
	? "ok" : "not ok" , " ", ++$loaded, "\n";

    print !$hasUnicode || $sjis0213re eq unicode_to_sjis0213($unicode)
	? "ok" : "not ok" , " ", ++$loaded, "\n";

    print $sjis0213re eq utf8_to_sjis0213($utf8)
	? "ok" : "not ok" , " ", ++$loaded, "\n";

    print $sjis0213re eq utf16le_to_sjis0213($utf16le)
	? "ok" : "not ok" , " ", ++$loaded, "\n";

    print $sjis0213re eq utf16be_to_sjis0213($utf16be)
	? "ok" : "not ok" , " ", ++$loaded, "\n";

    print $sjis0213re eq utf32le_to_sjis0213($utf32le)
	? "ok" : "not ok" , " ", ++$loaded, "\n";

    print $sjis0213re eq utf32be_to_sjis0213($utf32be)
	? "ok" : "not ok" , " ", ++$loaded, "\n";
}
